    ...
    >
      {items.map((item) => (
        <AccordionItem key={item.value} value={item.value} className="border-none">
          <AccordionTrigger className="px-3 py-3 bg-white bg-opacity-40 data-[state=open]:bg-opacity-80 backdrop-filter backdrop-blur-[2px] border border-white rounded-xl data-[state=open]:rounded-b-none data-[state=open]:rounded-lb-none data-[state=open]:pb-2 ">
